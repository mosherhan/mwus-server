window.fathom = (() => {
  ...
  if (
    ...
    "false" ==
      (fathomScript.getAttribute("data-auto") ||
        fathomScript.getAttribute("auto")) && (auto = !1),
    "false" ==
    ...
    fathomScript.getAttribute("data-spa") || fathomScript.getAttribute("spa"))
  )
    switch (
      fathomScript.getAttribute("data-spa") ||
      fathomScript.getAttribute("spa")
    ) {
      case "history":
        spaHistory();
        break;
      ...
      pairs[i] &&
        ...
        -1 <
          [
            ...
            "gclid",
            "msclkid",
          ].indexOf(decodeURIComponent(pair[0]))) &&
  ...
  function trackingEnabled() {
    ...
    try {
      fathomIsBlocked =
        window.localStorage &&
        window.localStorage.getItem("blockFathomTracking");
    } catch (err) {}
    var prerender =
    ...
    return (
      void 0 === params.url
        ? canonical &&
          ...
          (((a = document.createElement("a")).href = document.querySelector(
      ...
      }),
    {
      ...
      trackPageview: function (params) {
        ...
        "" !== location.host &&
          ...
          "hash" == fathomScript.getAttribute("data-spa") &&
